...
class HomeViewController: UITableViewController {
    @IBOutlet private var attributedPlaceholderTextView: PlaceholderUITextView!
    @IBOutlet private var noneInsetsLinePaddingTextView: PlaceholderUITextView!
    ...
    private func setupTextViews() {
        ...
        let description = """
        Add your professional advice for the test results. Once sent, your advice can not be editted.
        """
